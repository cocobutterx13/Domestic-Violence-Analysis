...
# SECTION 7: SUMMARY
# =============================================================================
# Full findings and interpretation documented in Domestic_Violence_Full_Report.pdf
# Key results: employment and marital status are the strongest predictors of
# violence; income shows a protective effect (OR = 0.28) but is constrained by
# zero-inflation and collinearity with employment (r = 0.92, adj. GVIF = 11.31).
# =============================================================================